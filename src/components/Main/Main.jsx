...
const Main = () => {
    return (
        <div className="mx-auto w-[90%]">
            <div className="bg-header bg-no-repeat bg-cover bg-center rounded-2xl mt-12">
              
                <div className="">
                    <div className="flex flex-col items-center py-32 px-5 text-white">
            ...
            <div className="text-center pt-8">
                    <h2 className="text-2xl lg:text-3xl font-bold mb-3">Our yum-yum Recipes</h2>
